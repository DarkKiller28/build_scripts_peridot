...
• InfinityX A17
```
crave run --no-patch -- "curl -v https://raw.githubusercontent.com/DarkKiller28/build_scripts_peridot/main/infinityx-17.sh | bash"
```
...
• PixelOS A16
```
crave run --no-patch -- "curl -v https://raw.githubusercontent.com/DarkKiller28/build_scripts_peridot/main/pixelos_16.2.sh | bash"
```
...
• EvolutionX A16
```
crave run --no-patch -- "curl -v https://raw.githubusercontent.com/DarkKiller28/build_scripts_peridot/main/evo_a16.sh | bash"
```

• YAAP A16
```
crave run --no-patch -- "curl -v https://raw.githubusercontent.com/DarkKiller28/build_scripts_peridot/main/yaap_a16.sh | bash"
```
